...
export function ContactCta() {
  return (
    <section id="contact" className="px-5 py-20 sm:px-8">
      <div className="mx-auto max-w-5xl rounded-[2rem] border border-white/10 bg-white/[0.04] p-8 text-center sm:p-14">
        ...
        <div className="mt-9 flex flex-col justify-center gap-3 sm:flex-row">
          <a href={contact.calendlyUrl} className="rounded-full bg-white px-6 py-3 text-sm font-semibold text-black transition hover:bg-lime-200">
            Book a call
          </a>
          <a href={`mailto:${contact.email}`} className="rounded-full border border-white/15 px-6 py-3 text-sm font-semibold text-white transition hover:border-white">
            Email me
          </a>
        </div>
      </div>
