      ...
      <div className="mx-auto grid max-w-7xl gap-12 lg:grid-cols-[1.08fr_0.92fr] lg:items-center">
        <div>
          ...
          <div className="mt-9 flex flex-col gap-3 sm:flex-row">
            <a href={contact.calendlyUrl} className="rounded-full bg-white px-6 py-3 text-center text-sm font-semibold text-black transition hover:bg-lime-200">
              Book a call
            </a>
            <a href="#work" className="rounded-full border border-white/15 px-6 py-3 text-center text-sm font-semibold text-white transition hover:border-white">
              View work
            </a>
          </div>
        </div>
        <div className="rounded-[2rem] border border-white/10 bg-white/[0.04] p-4 shadow-2xl shadow-black/40">
          <div className="aspect-[4/5] rounded-[1.5rem] border border-white/10 bg-[linear-gradient(145deg,#1f2937,#0a0a0a_55%,#84cc16)] p-6">
            <div className="flex h-full flex-col justify-between">
              ...
              <div>
                <p className="text-7xl font-semibold tracking-[-0.08em] text-white">Ed</p>
                <p className="mt-3 max-w-sm text-lg leading-7 text-zinc-200">
              ...
              <div className="grid grid-cols-3 gap-3 text-center text-xs text-white/75">
                ...
                <div className="rounded-2xl bg-white/10 p-3">Travel</div>
                <div className="rounded-2xl bg-white/10 p-3">UGC</div>
              </div>
            </div>
          </div>
        </div>
